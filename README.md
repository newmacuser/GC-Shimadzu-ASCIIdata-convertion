...
The v2 script is compatible with the modified GC method (developed by Miguel in Fall 2022), which measures 14 volatile chemicals. ~~If you're using the GC for 5 SCFA compounds (the older/classic method), please refer to the scripts in folder V1.~~ The v2 script is now compatible with **any** number of compounds.
