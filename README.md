...
The v2 script is compatible **only** with the modified GC method (developed by Miguel in Fall 2022), which measures 14 volatile chemicals. If you're using the GC method for 5 SCFA compounds (the older/classic method), please refer to the scripts in folder V1.  
