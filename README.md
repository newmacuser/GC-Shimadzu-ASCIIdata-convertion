...
The v2 script is compatible with the modified GC method (developed by Miguel in Fall 2022), which measures 14 volatile chemicals. ~~If you're using the GC for 5 SCFA compounds (the older/classic method), please refer to the scripts in folder V1.~~ **Update**: The v2 script is now compatible with any number of compounds.
...
The example output summary table has 15 columns with the following headers: “SampleID”, "Acetone", "Methanol", "2-Propanol", "Ethanol", "1-butanol", “Acetate”, “Propionate”, “Isobutyrate”, “Butyrate”, “Isovalerate”, "Valerate", “Isocorporate”, "Hexanoic acid", "Heptanoic acid". Compound concentrations are represented by the values in the table (mM). 
